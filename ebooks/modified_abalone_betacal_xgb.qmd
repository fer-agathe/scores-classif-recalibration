# Recalibration: Example {#sec-real-example-xgb}
...
recalibrate <- function(obs_calib,
  ...
  if (method == "platt") {
    ...
    if (i_grid == 3){
      fit_beta <- beta_calibration(data_calib$scores, data_calib$d, parameters = "am") # use am instead of abm to prevent pbs with uniroot function
    } else {
...
```{r load-data-priors}
load("../output/real-data/tb_abalone.rda") # dataset
load("../output/real-data/priors_abalone.rda") # scores_gamsel

prior <- priors_abalone
data <- tb_abalone
```
